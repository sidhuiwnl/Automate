                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Automate Your Work With Automake</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl">Automake is a powerful tool designed to streamline and automate repetitive tasks in your workflow. </p>
                        ...
                        <div className="perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56">
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-176 relative skew-x-[.36rad]">
                                    ...
                                    <Image className="rounded-(--radius) z-1 relative border dark:hidden" src="/temp-banner-for-automake.png" alt="tailus ui hero section" width={2880} height={2074} />
                                    <Image className="rounded-(--radius) z-1 relative hidden border dark:block" src="/temp-banner-for-automake.png" alt="tailus ui hero section" width={2880} height={2074} />
                                </div>
                            </div>
                        </div>
                    </div>
